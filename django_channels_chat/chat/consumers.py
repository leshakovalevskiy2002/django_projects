...
class JoinAndLeave(WebsocketConsumer):
    ...
    def receive(self, text_data=None, bytes_data=None):
        ...
        action = text_data.get("type")
        uuid = text_data.get("data")
        group = Group.objects.get(uuid=uuid)

        if action == "leave_group":
            self.leave_group(group, uuid)
        elif action == "join_group":
            self.join_group(group, uuid)


    def leave_group(self, group, group_uuid):
    ...
    def join_group(self, group, group_uuid):
